...
zpool create $ZPOOL_NAME mirror $ZPOOL_DEVS
...
~ilarik/Public/pgbench-run/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-defaults-nvme-no-slog -o /tmp/perftest/pgbench.out

...
zpool create $ZPOOL_NAME -o ashift=12 mirror $ZPOOL_DEVS log $ZPOOL_LOGS
...
~ilarik/Public/pgbench-run/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-ashift12-8k-thruput-and-latency-nvme-slog-pmem-concat -o /tmp/perftest/pgbench.out

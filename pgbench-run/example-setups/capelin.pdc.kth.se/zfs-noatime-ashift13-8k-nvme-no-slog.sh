...
zpool create $ZPOOL_NAME -o ashift=13 mirror $ZPOOL_DEVS
...
zfs create -o atime=off -o recordsize=8k $ZPOOL_NAME/db01
zfs create -o atime=off -o recordsize=8k $ZPOOL_NAME/xlog01
...
~ilarik/Public/pgbench-run/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-ashift13-8k-nvme-no-slog -o /tmp/perftest/pgbench.out

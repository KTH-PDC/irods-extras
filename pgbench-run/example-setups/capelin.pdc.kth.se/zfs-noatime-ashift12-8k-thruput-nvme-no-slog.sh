...
zfs create -o atime=off -o recordsize=8k -o logbias=throughput $ZPOOL_NAME/xlog01
...
~ilarik/Public/pgbench-run/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-ashift12-8k-thruput-nvme-no-slog -o /tmp/perftest/pgbench.out

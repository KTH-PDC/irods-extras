...
~ilarik/Public/pgbench-run/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-ashift12-8k-thruput-and-latency-nvme-no-slog -o /tmp/perftest/pgbench.out

...
zpool create $ZPOOL_NAME -o ashift=12 mirror $ZPOOL_DEVS
...
~ilarik/Public/pgbench-run/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-ashift12-8k-nvme-no-slog -o /tmp/perftest/pgbench.out

...
zfs create -o atime=off $ZPOOL_NAME/db01
zfs create -o atime=off $ZPOOL_NAME/xlog01
...
~ilarik/Public/pgbench-run/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-ashift13-nvme-no-slog -o /tmp/perftest/pgbench.out

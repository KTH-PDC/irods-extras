...
zpool create db01 wwn-0x`array_get_wwn 0 2` wwn-0x`array_get_wwn 0 3`
zpool create xlog01 wwn-0x`array_get_wwn 0 4`
...
./pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime -o /tmp/pgbench.out

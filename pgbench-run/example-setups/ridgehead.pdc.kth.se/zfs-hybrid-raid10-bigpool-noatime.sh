...
zfs create -o atime=off dbpool01/data
zfs create -o atime=off dbpool01/xlog

zfs create -o atime=off dbpool01/data/pgbench
zfs create -o atime=off dbpool01/xlog/pgbench
...
/tmp/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-hybrid-raid10-bigpool-noatime -o /tmp/pgbench.out

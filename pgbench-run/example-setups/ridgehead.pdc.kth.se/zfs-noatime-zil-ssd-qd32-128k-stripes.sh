...
array_create 0 6 128 1I:1:3,1I:1:4,1I:1:5,1I:1:6,1I:1:7,1I:1:8 
array_create 0 6 128 1I:1:9,1I:1:10,1I:1:11,1I:1:12,1I:1:13,2I:1:14
array_create 0 1+0 128 2I:1:15,2I:1:16,2I:1:17,2I:1:18,2I:1:19,2I:1:20
...
zpool create -f db01 wwn-0x`array_get_wwn 0 2` wwn-0x`array_get_wwn 0 3` log nvme0n1p1
zpool create -f xlog01 wwn-0x`array_get_wwn 0 4` log nvme0n1p2
...
/tmp/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-zil-ssd-qd32-128k-stripes -o /tmp/pgbench.out

...
zfs create -o atime=off -o logbias=throughput -o recordsize=8k dblog01/pgbench
...
/tmp/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-hybrid-raid10-12-disk-db-uncomp-8k-qd32-thruput -o /tmp/pgbench.out

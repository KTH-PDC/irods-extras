...
parted /dev/nvme0n1 mkpart primary 0% 16GB
parted /dev/nvme0n1 mkpart primary 16GB 32GB

zpool create db01 wwn-0x`array_get_wwn 0 2` wwn-0x`array_get_wwn 0 3` log nvme0n1p1
zpool create xlog01 wwn-0x`array_get_wwn 0 4` log nvme0n1p2 -o ashift=12

zfs create -o atime=off -o recordsize=8k db01/pgbench
zfs create -o atime=off -o recordsize=8k xlog01/pgbench
...
/tmp/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-nocache-8k-zil-ssd-ashift12 -o /tmp/pgbench.out

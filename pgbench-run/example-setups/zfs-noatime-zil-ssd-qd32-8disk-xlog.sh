...
array_create 0 1+0 default 2I:1:15,2I:1:16,2I:1:17,2I:1:18,2I:1:19,2I:1:20,2I:1:21,2I:1:22
...
/tmp/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-noatime-zil-ssd-qd32-8disk-xlog -o /tmp/pgbench.out

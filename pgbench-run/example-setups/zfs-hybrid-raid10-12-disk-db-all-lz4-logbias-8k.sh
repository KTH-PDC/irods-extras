...
array_create 0 1 128 1I:1:3,1I:1:4 caching=disable
array_create 0 1 128 1I:1:5,1I:1:6 caching=disable
array_create 0 1 128 1I:1:7,1I:1:8 caching=disable
array_create 0 1 128 1I:1:9,1I:1:10 caching=disable
array_create 0 1 128 1I:1:11,1I:1:12 caching=disable
array_create 0 1 128 1I:1:13,2I:1:14 caching=disable
array_create 0 1 128 2I:1:15,2I:1:16 caching=disable
array_create 0 1 128 2I:1:17,2I:1:18 caching=disable
array_create 0 1 128 2I:1:19,2I:1:20 caching=disable
array_create 0 1 128 2I:1:21,2I:1:22 caching=disable
array_create 0 1 128 2I:1:23,2I:1:24 caching=disable
...
zfs create -o atime=off -o compression=lz4 -o logbias=throughput -o recordsize=8k db01/pgbench
zfs create -o atime=off -o compression=lz4 -o logbias=latency dblog01/pgbench
...
/tmp/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-hybrid-raid10-12-disk-db-all-lz4-logbias-8k -o /tmp/pgbench.out

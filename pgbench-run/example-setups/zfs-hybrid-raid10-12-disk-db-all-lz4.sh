...
zfs create -o atime=off -o compression=lz4 db01/pgbench
zfs create -o atime=off -o compression=lz4 dblog01/pgbench
...
/tmp/pgbench-run.sh -c 10 -t 1000 -r 100 -d test -i zfs-hybrid-raid10-12-disk-db-all-lz4 -o /tmp/pgbench.out
